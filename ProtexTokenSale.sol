  ...
  */
  ...
  contract ProtexSale is ERC20, SafeMath{
    ...
    uint256 public TOKEN_SALE_PRICE = 12000000000000000000000; //1 ETH = 4000 PTX in the token sale
    uint256 public PRE_SALE_PRICE = 20000000000000000000000; //1 ETH = 5000 PTX in the pre sale
    ...
    uint256 public PRE_SALE_END_TIME = 4520000; //end of pre-sale (November 6th)
    uint256 public TOKEN_SALE_START_TIME = 4570000; //beginning of token sale (November 13th)
    uint256 public TOKEN_SALE_END_TIME = 4720000; //end of token sale (December 11th)
